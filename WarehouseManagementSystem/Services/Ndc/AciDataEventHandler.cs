    ...
    public class AciDataEventHandler
    {
        ...
        private async Task HandleOrderEvent(AciDataEventArgs e)
        {
            try
            {
                ...
                var ndcTask = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2);
                switch (ev.Type)
                {
                    ...
                    case AciHostEventTypeEnum.RelaseTask:
                        var relaseTaskModel = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2);
                        if (relaseTaskModel != null)
                        {
                            ...
                            if (wmsModel != null)
                            {
                                ...
                                {
                                    var groupTasks = await _taskDataService.GetUserTasksAsync(x => x.taskGroupNo == wmsModel.taskGroupNo);
        ...
        private async Task HandleOrderStartEvent(AciEvent ev)
        {
            ...
            var ndcTasks = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.None);
            if (ndcTasks != null)
            {
            ...
            var ndcTasksInProgress = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.TaskStart);
        ...
        private async Task HandleMoveToLoadEvent(AciEvent ev)
        {
            ...
            var move = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.TaskStart);
            if (move != null)
            {
        ...
        private async Task HandleLoadHostSyncronisationEvent(AciEvent ev)
        {
            ...
            try
            {
                ...
                var load0 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.ConfirmCar);
                if (load0 != null)
                {
                ...
                var load1 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.PickingUp);
                if (load1 != null)
                {
        ...
        private async Task HandleLoadingHostSyncronisationEvent(AciEvent ev)
        {
            ...
            var vehicleAtLoad0 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2);
            ...
            var loadDone0 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.PickingUp);
            if (loadDone0 != null)
            {
            ...
            var loadDone1 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.PickDown);
            if (loadDone1 != null)
            {
                _aciAppManager.SendHostAcknowledge(null, ev.Index, (int)ReplyTaskState.PickDown, 0, 0);
                return;
        ...
        {
            // 获取当前任务信息
            var ndcTaskModel = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2);
            ...
            var unoad0 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.PickDown);
            if (unoad0 != null)
            {
            ...
            var unoad1 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.Unloading);
            if (unoad1 != null)
            {
            ...
            var unoad2 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.OrderAgv);
            if (unoad2 != null)
            {
            ...
            var unoad3 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.CanceledWashing);
            if (unoad3 != null)
            {
        ...
        private async Task HandleUnloadingHostSyncronisationEvent(AciEvent ev)
        {
            ...
            var unloadDone0 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.Unloading);
            if (unloadDone0 != null)
            {
            ...
            var unloadDone1 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.UnloadDown);
            if (unloadDone1 != null)
            {
                _aciAppManager.SendHostAcknowledge(null, ev.Index, (int)ReplyTaskState.UnloadDown, 0, 0);
                return;
            ...
            var unloadDone2 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.OrderAgv);
            if (unloadDone2 != null)
            {
                _aciAppManager.SendHostAcknowledge(null, ev.Index, (int)ReplyTaskState.UnloadDown, 0, 0);
                return;
            ...
            var unloadDone3 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.CanceledWashing);
            if (unloadDone3 != null)
            {
                _aciAppManager.SendHostAcknowledge(null, ev.Index, (int)ReplyTaskState.UnloadDown, 0, 0);
                return;
        ...
        private async Task HandleOrderFinishEvent(AciEvent ev)
        {
            ...
            var finish0 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.UnloadDown);
            if (finish0 != null)
            {
            ...
            var finish1 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.OrderAgv);
            ...
            var finish2 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.CanceledWashing);
        ...
        {
            var invalidDown0 = await _taskDataService.FindNdcTaskAsync(x =>
                x.NdcTaskId == ev.Parameter2 &&
                (int)x.TaskStatus != (int)NdcTaskStatuEnum.InvalidDown);
            ...
            var invalidDown1 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.InvalidDown);
        ...
        {
            var orderCancl0 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus != NdcTaskStatuEnum.CanceledWashing);
            ...
            var orderCancl1 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.CanceledWashing);
        ...
        {
            var cancelTasks = await _taskDataService.GetNdcTasksAsync(i => i.TaskStatus >= NdcTaskStatuEnum.CarWash && i.TaskStatus < NdcTaskStatuEnum.TaskFinish);
        ...
        {
            var fetch0 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus != NdcTaskStatuEnum.RedirectRequest);
            if (fetch0 != null)
            {
            ...
            var fetch1 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.RedirectRequest);
            if (fetch1 != null)
            {
                _aciAppManager.SendHostAcknowledge(null, ev.Index, (int)ReplyTaskState.ConfirmCancellation, 0, 0);
                return;
        ...
        private async Task HandleOrderAgvEvent(AciEvent ev)
        {
            ...
            var orderAgv0 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus != NdcTaskStatuEnum.OrderAgv);
            if (orderAgv0 != null)
            {
            ...
            var orderAgv1 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.OrderAgv);
            if (orderAgv1 != null)
            {
                _aciAppManager.SendHostAcknowledge(null, ev.Index, (int)ReplyTaskState.ConfirmRedirection, 0, 0);
                return;
        ...
        {
            var invalidUp0 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus != NdcTaskStatuEnum.InvalidUp);
            if (invalidUp0 != null)
            {
            ...
            var invalidUp1 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.InvalidUp);
            if (invalidUp1 != null)
            {
                _aciAppManager.SendHostAcknowledge(null, ev.Index, (int)ReplyTaskState.ConfirmCancellation, 0, 0);
                return;
        ...
        private async Task HandleEndEvent(AciEvent ev)
        {
            ...
            var recovery = await _taskDataService.GetNdcTasksAsync(x => x.NdcTaskId == ev.Parameter1);
        ...
        {
            var cancel0 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus != NdcTaskStatuEnum.Canceled);
            ...
            var cancel1 = await _taskDataService.FindNdcTaskAsync(x => x.NdcTaskId == ev.Parameter2 && x.TaskStatus == NdcTaskStatuEnum.Canceled);
